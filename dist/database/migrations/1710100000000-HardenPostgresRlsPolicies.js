...
Object.defineProperty(exports, "HardenPostgresRlsPolicies1710100000000", {
    enumerable: true,
    get: function() {
        return HardenPostgresRlsPolicies1710100000000;
    }
});
let HardenPostgresRlsPolicies1710100000000 = class HardenPostgresRlsPolicies1710100000000 {
    ...
    `);
        await queryRunner.query(`DROP POLICY IF EXISTS document_signatures_tenant_delete ON document_signatures;`);
        await queryRunner.query(`DROP POLICY IF EXISTS document_signatures_tenant_update ON document_signatures;`);
        await queryRunner.query(`DROP POLICY IF EXISTS document_signatures_tenant_insert ON document_signatures;`);
        await queryRunner.query(`DROP POLICY IF EXISTS document_signatures_tenant_select ON document_signatures;`);
        await queryRunner.query(`DROP POLICY IF EXISTS user_identities_tenant_delete ON user_identities;`);
        await queryRunner.query(`DROP POLICY IF EXISTS user_identities_tenant_update ON user_identities;`);
        await queryRunner.query(`DROP POLICY IF EXISTS user_identities_tenant_insert ON user_identities;`);
        await queryRunner.query(`DROP POLICY IF EXISTS user_identities_tenant_select ON user_identities;`);
        await queryRunner.query(`DROP FUNCTION IF EXISTS current_user_has_elevated_tenant_role();`);
    ...
    async recreateTenantPolicies(queryRunner, tableName) {
        const prefix = tableName === "onboarding_progress" ? "onboarding_progress" : tableName;
        await queryRunner.query(`DROP POLICY IF EXISTS ${prefix}_tenant_select ON ${tableName};`);
        await queryRunner.query(`DROP POLICY IF EXISTS ${prefix}_tenant_insert ON ${tableName};`);
        await queryRunner.query(`DROP POLICY IF EXISTS ${prefix}_tenant_update ON ${tableName};`);
        await queryRunner.query(`DROP POLICY IF EXISTS ${prefix}_tenant_delete ON ${tableName};`);
        await queryRunner.query(`
    ...
    constructor(){
        this.name = "HardenPostgresRlsPolicies1710100000000";
    }
};

//# sourceMappingURL=1710100000000-HardenPostgresRlsPolicies.js.map