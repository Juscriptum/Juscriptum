...
Object.defineProperty(exports, "AddScanSessionsWorkflow1711000000000", {
    enumerable: true,
    get: function() {
        return AddScanSessionsWorkflow1711000000000;
    }
});
let AddScanSessionsWorkflow1711000000000 = class AddScanSessionsWorkflow1711000000000 {
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`DROP INDEX IF EXISTS idx_scan_sessions_created_by`);
        await queryRunner.query(`DROP INDEX IF EXISTS idx_scan_sessions_tenant_case`);
        await queryRunner.query(`DROP TABLE IF EXISTS scan_pages`);
        await queryRunner.query(`DROP TABLE IF EXISTS scan_sessions`);
    }
    constructor(){
        this.name = "AddScanSessionsWorkflow1711000000000";
    }
};

//# sourceMappingURL=1711000000000-AddScanSessionsWorkflow.js.map