...
Object.defineProperty(exports, "HardenUserIsolationAndTrustProviders1709900000000", {
    enumerable: true,
    get: function() {
        return HardenUserIsolationAndTrustProviders1709900000000;
    }
});
let HardenUserIsolationAndTrustProviders1709900000000 = class HardenUserIsolationAndTrustProviders1709900000000 {
    ...
    async down(queryRunner) {
        await queryRunner.query(`DROP INDEX IF EXISTS idx_document_signatures_user_id;`);
        await queryRunner.query(`DROP INDEX IF EXISTS idx_document_signatures_document_id;`);
        await queryRunner.query(`DROP INDEX IF EXISTS idx_document_signatures_tenant_id;`);
        await queryRunner.query(`DROP TABLE IF EXISTS document_signatures;`);
        await queryRunner.query(`DROP INDEX IF EXISTS idx_user_identities_provider;`);
        await queryRunner.query(`DROP INDEX IF EXISTS idx_user_identities_user_id;`);
        ...
        await queryRunner.query(`ALTER TABLE documents DROP COLUMN IF EXISTS access_scope;`);
        await queryRunner.query(`ALTER TABLE clients DROP COLUMN IF EXISTS access_scope;`);
        await queryRunner.query(`ALTER TABLE cases DROP COLUMN IF EXISTS access_scope;`);
    }
    constructor(){
        this.name = "HardenUserIsolationAndTrustProviders1709900000000";
    }
};

//# sourceMappingURL=1709900000000-HardenUserIsolationAndTrustProviders.js.map