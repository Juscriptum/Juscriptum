...
Object.defineProperty(exports, "AddTrustVerificationWorkflow1710400000000", {
    enumerable: true,
    get: function() {
        return AddTrustVerificationWorkflow1710400000000;
    }
});
let AddTrustVerificationWorkflow1710400000000 = class AddTrustVerificationWorkflow1710400000000 {
    ...
    async down(queryRunner) {
        await queryRunner.query(`DROP INDEX IF EXISTS "idx_user_identities_status"`);
        await queryRunner.query(`
      ALTER TABLE "user_identities"
    ...
    `);
        await queryRunner.query(`DROP INDEX IF EXISTS "idx_document_signatures_verification_status"`);
        await queryRunner.query(`
      ALTER TABLE "document_signatures"
      DROP COLUMN "external_verification_id",
      DROP COLUMN "last_error",
    ...
    `);
        await queryRunner.query(`DROP INDEX IF EXISTS "idx_trust_verification_jobs_provider"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "idx_trust_verification_jobs_status_next_attempt"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "idx_trust_verification_jobs_subject"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "idx_trust_verification_jobs_tenant_id"`);
        await queryRunner.query(`DROP TABLE "trust_verification_jobs"`);
    }
    constructor(){
        this.name = "AddTrustVerificationWorkflow1710400000000";
    }
};

//# sourceMappingURL=1710400000000-AddTrustVerificationWorkflow.js.map