...
Object.defineProperty(exports, "AddDocumentProcessingWorkflow1711100000000", {
    enumerable: true,
    get: function() {
        return AddDocumentProcessingWorkflow1711100000000;
    }
});
let AddDocumentProcessingWorkflow1711100000000 = class AddDocumentProcessingWorkflow1711100000000 {
    ...
    async down(queryRunner) {
        await queryRunner.query(`DROP INDEX IF EXISTS idx_document_processing_artifacts_document_page`);
        await queryRunner.query(`DROP INDEX IF EXISTS idx_document_processing_artifacts_job_kind`);
        await queryRunner.query(`DROP INDEX IF EXISTS idx_document_processing_artifacts_tenant_id`);
        await queryRunner.query(`DROP INDEX IF EXISTS idx_document_processing_jobs_status`);
        await queryRunner.query(`DROP INDEX IF EXISTS idx_document_processing_jobs_document_id`);
        await queryRunner.query(`DROP INDEX IF EXISTS idx_document_processing_jobs_tenant_id`);
        await queryRunner.query(`DROP TABLE IF EXISTS document_processing_artifacts`);
        await queryRunner.query(`DROP TABLE IF EXISTS document_processing_jobs`);
    }
    constructor(){
        this.name = "AddDocumentProcessingWorkflow1711100000000";
    }
};

//# sourceMappingURL=1711100000000-AddDocumentProcessingWorkflow.js.map