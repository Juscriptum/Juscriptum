...
Object.defineProperty(exports, "AddUkrainianCaseFields1700000000000", {
    enumerable: true,
    get: function() {
        return AddUkrainianCaseFields1700000000000;
    }
});
const _typeorm = require("typeorm");
let AddUkrainianCaseFields1700000000000 = class AddUkrainianCaseFields1700000000000 {
    async up(queryRunner) {
        // Add proceeding_stage column
        await queryRunner.addColumn("cases", new _typeorm.TableColumn({
        ...
        await queryRunner.createIndex("cases", new _typeorm.TableIndex({
    ...
    constructor(){
        this.name = "AddUkrainianCaseFields1700000000000";
    }
};

//# sourceMappingURL=1700000000000-AddUkrainianCaseFields.js.map