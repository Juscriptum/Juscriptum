export type PlatformAdminPhase = "mvp" | "phase_2";

export interface PlatformAdminScreenBlueprint {
  id: string;
  phase: PlatformAdminPhase;
  title: string;
  route: string;
  purpose: string;
  sections: string[];
...
export interface PlatformAdminApiBlueprint {
  phase: PlatformAdminPhase;
  method: "GET" | "POST" | "PATCH";
  path: string;
  summary: string;
  sensitivity: "platform_metadata" | "platform_control";
  reasonRequired?: boolean;
}

export interface PlatformAdminSecurityDecision {
  id: string;
  title: string;
  decision: string;
  rationale: string;
  status: "locked_for_mvp" | "phase_2";
}

export interface PlatformAdminBlueprint {
  updatedAt: string;
  frontendEntry: string;
  backendPrefix: string;
  backendModuleRoot: string;
  frontendModuleRoot: string;
  principles: string[];
  disabledCapabilities: string[];
  temporaryConstraints: string[];
  securityDecisions: PlatformAdminSecurityDecision[];
  screens: PlatformAdminScreenBlueprint[];
  api: PlatformAdminApiBlueprint[];
  nextImplementationSteps: string[];
}

export const PLATFORM_ADMIN_BLUEPRINT: PlatformAdminBlueprint = {
  ...
  securityDecisions: [
    {
      ...
      decision:
        "Expose platform-admin as a distinct HTML entry and layout instead of linking it from the tenant SPA.",
      rationale:
        "This keeps the owner back office out of the user navigation surface and avoids accidental reuse of tenant-only UX assumptions.",
    ...
    },
    {
      ...
      decision:
        "Introduce PlatformAdminUser and PlatformAdminSession instead of modeling the portal owner as another organization member.",
      rationale:
        "The current auth and RLS model expects tenant-bound identities and should not become the source of truth for portal-owner access.",
      status: "locked_for_mvp",
    },
    {
      id: "metadata-first",
      ...
      decision:
        "Platform-admin screens must default to organization metadata, security posture, and operational diagnostics.",
      rationale:
        "This is the safest way to support billing and support workflows without exposing attorney-client data by default.",
      status: "locked_for_mvp",
    },
    {
      id: "break-glass",
      ...
      decision:
        "Any temporary read access to tenant content requires a separate Phase 2 workflow with approval, TTL, and full audit.",
      rationale:
        "Support convenience is not enough to justify direct access to privileged legal data in MVP.",
      status: "phase_2",
    },
  ],
  screens: [
    {
      ...
      route: "/login",
      purpose:
        "Dedicated owner/admin sign-in with one-time bootstrap for the first operator, MFA verification, and required MFA setup.",
      sections: [
    ...
    },
    {
      ...
      route: "/dashboard",
      purpose:
        "Platform-wide health summary across organizations, billing, security, and worker alerts.",
      sections: [
        "Organization KPIs",
        "Billing anomalies",
        "Security alerts",
    ...
    },
    {
      ...
      route: "/organizations",
      purpose:
        "Search and filter tenant accounts by status, plan, activity, and risk without exposing client data.",
      sections: [
        "Search and filters",
    ...
    },
    {
      ...
      purpose:
        "Single-tenant back-office view for support, billing, security, and operational review.",
      sections: ["Overview", "Users", "Billing", "Security", "Ops", "Audit"],
    },
    {
      id: "ops",
      phase: "mvp",
      ...
      route: "/ops",
      purpose:
        "Review readiness, providers, worker backlog, and high-signal platform incidents.",
      sections: [
        "Platform readiness",
    ...
    },
    {
      ...
      route: "/audit",
      purpose:
        "Track who performed platform-admin actions, on which tenant, and for what reason.",
      sections: [
        "Actor identity",
        "Target organization",
        "Reason field",
    ...
    },
    {
      ...
      route: "/billing",
      purpose:
        "Investigate provider sync issues, credits, disputes, and grace-period handling.",
      sections: [
        "Provider status",
        "Invoice timeline",
        "Manual credits",
    ...
    },
    {
      ...
      route: "/support",
      purpose:
        "Centralize support notes, ticket linkage, canned actions, and escalation history.",
      sections: [
        "Support notes",
        "Escalation state",
    ...
    },
    {
      ...
      route: "/feature-flags",
      purpose:
        "Enable staged rollouts, tenant-specific toggles, and emergency kill switches.",
      sections: ["Tenant overrides", "Rollout cohorts", "Emergency toggles"],
    },
    {
      id: "compliance",
      phase: "phase_2",
      ...
      route: "/compliance",
      purpose:
        "Manage retention, legal hold, tenant export/delete workflows, and policy version tracking.",
      sections: [
        "Retention policy",
        "Export jobs",
        "Deletion workflow",
  ...
  api: [
    {
      ...
      summary:
        "Check whether the owner back office still needs the first platform-admin bootstrap.",
    ...
    },
    {
      ...
      summary:
        "Create the first platform owner via a one-time bootstrap token.",
    ...
    },
    {
      ...
      summary:
        "Generate a fresh TOTP enrollment kit with QR code and backup codes.",
      sensitivity: "platform_control",
    },
    {
      phase: "mvp",
      ...
      summary:
        "Confirm TOTP enrollment and rotate the session into MFA-backed access.",
      sensitivity: "platform_control",
    },
    {
      phase: "mvp",
      ...
      summary:
        "Return the authenticated platform-admin identity and permissions.",
      sensitivity: "platform_metadata",
    },
    {
      phase: "mvp",
    ...
    },
    {
      ...
      summary:
        "Single organization read model with overview, security, ops, and billing metadata.",
      sensitivity: "platform_metadata",
    },
    {
      phase: "mvp",
      ...
      summary:
        "Masked organization-user roster for ownership, status, and MFA review.",
      sensitivity: "platform_metadata",
    },
    {
      phase: "mvp",
    ...
    },
    {
      ...
      summary:
        "Invalidate active sessions for a tenant owner/support incident.",
      sensitivity: "platform_control",
      reasonRequired: true,
    },
    {
      ...
      summary:
        "Reset owner MFA enrollment as part of a verified recovery flow.",
      sensitivity: "platform_control",
      reasonRequired: true,
    },
    {
      ...
      summary:
        "Platform operations summary around readiness, backlog, and providers.",
      sensitivity: "platform_metadata",
    },
    {
      phase: "mvp",
      ...
      summary:
        "Platform-admin audit stream with actor, target, and reason metadata.",
      sensitivity: "platform_metadata",
    },
    {
      phase: "phase_2",
      ...
      summary:
        "Provider reconciliation, dispute review, and invoice exception handling.",
      sensitivity: "platform_metadata",
    },
    {
      phase: "phase_2",
    ...
    },
    {
      ...
      summary:
        "Request time-bound break-glass access with approval and full audit.",
      sensitivity: "platform_control",
      reasonRequired: true,
    },
  ],
