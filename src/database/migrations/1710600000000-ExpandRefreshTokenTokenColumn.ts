...
export class ExpandRefreshTokenTokenColumn1710600000000 implements MigrationInterface {
  name = "ExpandRefreshTokenTokenColumn1710600000000";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    if (dbType === "sqlite" || dbType === "better-sqlite3") {
      ...
      await queryRunner.query(
        `ALTER TABLE refresh_tokens_tmp RENAME TO refresh_tokens`,
      );
      await queryRunner.query(
