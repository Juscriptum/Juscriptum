...
export class InitAuthSchema1704067200000 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX IF EXISTS idx_onboarding_progress_completed`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX IF EXISTS idx_onboarding_progress_tenant_id`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX IF EXISTS idx_password_resets_tenant_id`,
    );
